...
Audited golden examples and reusable fixtures, grouped by the question each artifact answers.
...
- [KR — 삼성SDS Memo](<../analysis-example/kr/삼성SDS/memo.md>) — enterprise IT example with valuation history and Naver outside views.
...
## Street / Alternative Views — filings vs outside narratives
...
- [KR Sector — 국내 데이터센터 리서치 브리프](<../analysis-example/kr-sector/국내 데이터센터-리서치브리프.md>) — scoped planning artifact.
