...
function main() {
  ...
  const artifact = {
    ...
    commonRules: { costOneWay: L.COST, signal: 'month-end adjusted close', execution: 'next trading-day open', reversalWindow: REV_WINDOW, volWindow: VOL_WINDOW, cashResidual: true },
    ...
    warnings: [...L.DISCLAIMER, `반전 신호는 최근 ${REV_WINDOW}거래일 수익률이며, 값이 낮을수록(최대 하락) 상위. 회전율이 높아 25bp 비용의 영향이 크다.`],
  };
