# 한진칼(180640) — Follow-up Resolution + 5주 갱신 (2026-06-28)

- 기준일: 2026-06-28
- 직전 메모: `analysis-example/kr/한진칼/memo.md` (기준일 2026-05-22)
- 본 메모 범위: 직전 메모의 §16 Follow-up 중 6개 신규 해소 + 2026-05-23~06-28 신규 이벤트 통합. baseline 본문(§2~§15)은 중복하지 않음.
- 종가: 115,200원 (KOSPI, 2026-06-26)
- Phase B 채널 커버리지 갱신: DART ✓ · Chart ✓ · 정기주총 결과 ✓(신규) · 자회사 사업보고서 ✓(신규) · NPS 가이드라인 ✓(신규) · 외인 IB ✗ (스킬 버그 동일)
