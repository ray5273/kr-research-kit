# 대양전기공업(108380) 스윙 차트 체크리스트

- 대상: 대양전기공업
- 티커: 108380
- 기준일: 2026-07-10
- 분석 범위: 일봉 가격·거래량·기술지표만 사용. 펀더멘털·공시·밸류에이션·사업 내용은 제외.
...
- [대양전기공업 2년 일봉 데이터 및 산출 메타데이터](chart-data.json) — Yahoo Finance Chart API 수집, 2026-07-11 갱신.
- [기술지표·이동평균·일목·모멘텀 산출표](chart-analysis.md) — 2026-07-10 최신 완료 거래일 기준.
- [수평 매물대·피벗 구간 CSV](../assets/대양전기공업-chart-structure-zones.csv) — ATR 허용오차 기반 일봉 구조 구간.
